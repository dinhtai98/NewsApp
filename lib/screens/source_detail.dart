...
import 'package:newapp/bloc/get_source_news_bloc.dart';
...
class SourcesDetail extends StatefulWidget {
  final SourceModel source;

  const SourcesDetail({Key key, this.source}) : super(key: key);
  @override
  _SourcesDetailState createState() => _SourcesDetailState(source);
}

class _SourcesDetailState extends State<SourcesDetail> {
  final SourceModel source;
  _SourcesDetailState(this.source);
  @override
  void initState() {
    super.initState();
